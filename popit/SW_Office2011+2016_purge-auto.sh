...
#printf "\n\nWe will now remove the Office folder from /Applications/ and any application which begins "Microsoft ".\n"
...
#printf "\n\nWe will now remove each user's com files from their ~/Containers/ folder."
#read -p "Press <ENTER> to continue (or ctrl-C will abort)."
rm -R /Users/*/Library/Containers/com.microsoft*
rm -R /Private/var/root/Library/Containers/com.microsoft*

# Added 20151028 for 1016
#printf "\n\nWe will now remove each user's Office related folders from their Group Containers folder."
#read -p "Press <ENTER> to continue (or ctrl-C will abort)."
