...
defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText "Please return to POP, Inc\n1326 Fifth Avenue, Suite 800; Seattle, WA 98101\n206-728-7997"
...
# ssh root@mac-conf-test2274 'defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText "Please return to POP, Inc\n1326 Fifth Avenue, Suite 800; Seattle, WA 98101\n206-728-7997"'
